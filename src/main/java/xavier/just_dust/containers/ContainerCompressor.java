...
import xavier.just_dust.slots.SlotCompressorOutput;
...
public class ContainerCompressor extends Container {
    ...
    public ContainerCompressor(InventoryPlayer playerInventory, IInventory furnaceInventory) {
        this.tileFurnace = furnaceInventory;
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 56, 17));
        this.addSlotToContainer(new SlotCompressorFuel(furnaceInventory, 1, 56, 53));
        this.addSlotToContainer(new SlotCompressorOutput(playerInventory.player, furnaceInventory, 2, 116, 35));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index == 2) {
                ...
                if (CompressorRecipes.instance().getCompressingResult(itemstack1) != null) {
