...
import xavier.just_dust.common.slots.SlotCompressorOutput;
...
public class ContainerCharger extends Container {
    ...
    public ContainerCharger(InventoryPlayer playerInventory, IInventory compressorInventory) {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index == 2) {
                ...
                if (!ChargingRecipes.instance().getChargingResult(itemstack1).isEmpty()) {
                    if (!this.mergeItemStack(itemstack1, 0, 1, false)) {
                        return ItemStack.EMPTY;
                    }
                }
                else if (TileEntityCompressorTierOne.isItemFuel(itemstack1)) {
