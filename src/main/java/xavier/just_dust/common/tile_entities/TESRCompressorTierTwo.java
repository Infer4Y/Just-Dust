...
public class TESRCompressorTierTwo extends TileEntitySpecialRenderer<TileEntityCompressorTierTwo> {


    @Override
    public void render(TileEntityCompressorTierTwo te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
