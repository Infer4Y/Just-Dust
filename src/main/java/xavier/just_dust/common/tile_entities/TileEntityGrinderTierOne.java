...
public class TileEntityGrinderTierOne extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public String getName() {
        return this.hasCustomName() ? this.grinderCustomName : "container.grinder_tier_one";
    }
    ...
    public void update() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isRunning()) {
                flag1 = true;
                BlockGrinderTierOne.setState(this.isRunning(), this.world, this.pos);
            }
        }
    ...
    public String getGuiID() {
        return "just_dust:grinder_tier_one";
    }
    ...
    public int getCookTime(ItemStack stack) {
        return Math.round(GrinderRecipes.instance().getGrindingTime(stack) * 1.5f);
    }
