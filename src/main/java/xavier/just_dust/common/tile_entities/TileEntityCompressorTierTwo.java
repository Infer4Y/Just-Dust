...
public class TileEntityCompressorTierTwo extends TileEntityLockable implements ITickable, ISidedInventory {
    ...
    public String getName() {
        return this.hasCustomName() ? this.compressorCustomName : "container.compressor_tier_two";
    }
    ...
    public void update() {
        ...
        if (!this.world.isRemote) {
            ...
            if (flag != this.isRunning()) {
                flag1 = true;
                BlockCompressorTierTwo.setState(this.isRunning(), this.world, this.pos);
            }
        }
    ...
    public int getCookTime(ItemStack stack) {
        return Math.round(CompressorRecipes.instance().getCompressingTime(stack) * 1f);
    }
    ...
    public String getGuiID() {
        return "just_dust:compressor_tier_two";
    }
