...
public class GUICompressor extends GuiContainer {
    ...
    private final TileEntityCompressorTierOne tileFurnace;

    public GUICompressor(InventoryPlayer playerInv, TileEntityCompressorTierOne furnaceInv) {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (TileEntityCompressorTierOne.isRunning(this.tileFurnace)) {
