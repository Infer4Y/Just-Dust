...
public class GUICompressorTierTwo extends GuiContainer {
    private static final ResourceLocation FURNACE_GUI_TEXTURES = new ResourceLocation("textures/gui/container/furnace.png");
    /**
     * The player inventory bound to this GUI.
     */
    private final InventoryPlayer playerInventory;
    private final TileEntityCompressorTierTwo tileFurnace;

    public GUICompressorTierTwo(InventoryPlayer playerInv, TileEntityCompressorTierTwo furnaceInv) {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (TileEntityCompressorTierTwo.isRunning(this.tileFurnace)) {
